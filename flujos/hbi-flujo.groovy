...
def flujo() 
{
  pipeline 
  {
    try 
    {
      ...
      {
        //sh "aws ecs update-service --cluster ${ENVNAME}-cluster --service ${ENVNAME}-${APPNAME}-service --task-definition ${ENVNAME}-${APPNAME}-task --force-new-deployment"
      ...
      {
        //sh "aws ecs update-service --cluster sandbox-cluster --service sandbox-${APPNAME}-service --task-definition sandbox-${APPNAME}-task --force-new-deployment"
